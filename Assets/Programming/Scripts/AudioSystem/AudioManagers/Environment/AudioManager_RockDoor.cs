...
public class AudioManager_RockDoor : AudioManager
{
    ...
    {
        //Fetch Mixer
        AudioMixer _rockDoorMixer = Resources.Load<AudioMixer>("Data/AudioData/Mixers/RockDoor");
        ...
        {
            Sound s = new Sound(
            Resources.Load<AudioClip>("Data/AudioData/AudioClips/RockDoor/Open/RockDoor_Open_" + i),
            "RockDoor_Open_",
            _rockDoorMixer.FindMatchingGroups("Master")[1]
            );
            _sounds.Add(s);
        }
        ...
        {
            Sound s = new Sound(
            Resources.Load<AudioClip>("Data/AudioData/AudioClips/RockDoor/Close/RockDoor_Close_" + i),
            "RockDoor_Close_" + i,
            _rockDoorMixer.FindMatchingGroups("Master")[2]
            ); _sounds.Add(s);
        }
    }
